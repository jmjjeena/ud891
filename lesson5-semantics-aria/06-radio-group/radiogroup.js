(function() {
  ...
  function RadioGroup(id) {
    ...
    this.el.setAtrribute('role','radiogroup');
    ...
    for (var button of this.buttons) {
      ...
      button.setAtrribute('role','radio');
    }
  ...
  RadioGroup.prototype.changeFocus = function() {
    ...
    this.focusedButton.setAtrribute('aria-checked','false');
    ...
    this.focusedButton.setAtrribute('aria-checked','true');
  };
